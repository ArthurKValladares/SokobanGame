...
**Status:** implemented September 15, 2026. Options pages derive their natural height from the layout tree and scale their complete vertical presentation to fit when needed. Focus, pointer targets, and Back remain available throughout the supported window matrix.
