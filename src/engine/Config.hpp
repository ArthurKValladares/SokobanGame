...
inline constexpr float playerTileScale = 1.1f;
...
inline constexpr uint32_t playerIdleAnimationNumber = 8; // Idle_B in Rig_Medium_General
inline constexpr uint32_t playerPushAnimationNumber = 1; // Push_Walk in custom/Rig_Medium_Push (generated by tools/make_push_animation.py)
