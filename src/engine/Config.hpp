...
inline constexpr Vec4 waterSurfaceColor { 0.05f, 0.38f, 0.72f, 0.58f };
inline constexpr float waterRippleSpatialFrequency = 5.25f;
inline constexpr float waterRippleSpeed = 1.15f;
inline constexpr float waterRefractionStrength = 0.0035f;
